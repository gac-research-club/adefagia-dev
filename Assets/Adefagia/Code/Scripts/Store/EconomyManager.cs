...
namespace Adefagia.Store
{
    public class EconomyManager : MonoBehaviour
    {
        ...
        public CurrencyView currencyHudView;
        ...
        List<ItemAndAmountSpec> ParseEconomyItems(List<PurchaseItemQuantity> itemQuantities)
        {
            ...
            foreach (var itemQuantity in itemQuantities)
            {
                ...
                var name = itemQuantity.Item.GetReferencedConfigurationItem().Name;

                itemsAndAmountsSpec.Add(new ItemAndAmountSpec(id, itemQuantity.Amount, name));
            }
