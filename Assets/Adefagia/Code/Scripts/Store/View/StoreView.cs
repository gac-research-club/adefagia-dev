...
namespace Adefagia.Store
{
    ...
    {
        public StoreManager virtualShopSceneManager;
        ...
        public StoreItemView virtualShopItemPrefab;
        ...
        public void Initialize(Dictionary<string, CategoryItem> virtualShopCategories)
        {
        ...
        public void ShowCategory(CategoryItem virtualShopCategory)
        {
        ...
        void ShowItems(CategoryItem virtualShopCategory)
        {
            ...
            foreach (var virtualShopItem in virtualShopCategory.virtualShopItems)
            {
                ...
                virtualShopItemGameObject.GetComponent<StoreItemView>().Initialize(
